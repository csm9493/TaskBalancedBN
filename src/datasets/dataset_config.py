...
#         'normalize': ((0.5, 0.5, 0.5), (1, 1, 1)),
    ...
    'stl10': {
        'path': join(_BASE_DATA_PATH, 'stl10'),
        'normalize': ((0.4467, 0.4398, 0.4066), (0.2241, 0.2215, 0.2239)),
#         'normalize': ((0.5, 0.5, 0.5), (1, 1, 1)),
        'resize': (64, 64),
        'pad': 4,
        'crop': 64,
...
#     },
    'imagenet1000': {
        'path': join(_BASE_DATA_PATH, 'imagenet1000'),
        'resize': None,
        'crop': 224,
        'flip': True,
        'normalize': ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
    ...
    'imagenet100': {
        'path': join(_BASE_DATA_PATH, 'imagenet100'),
        'resize': None,
        'crop': 224,
        'flip': True,
        'normalize': ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225)),
    ...
    'MS_COCO_2017_unsup': {
        'path': join(_BASE_DATA_PATH, 'ms_coco_2017_unsup'),
        'resize': None,
        'crop': 224,
        'flip': True,
        'normalize': ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225)),
...
#         'normalize': ((0.485, 0.456, 0.406), (0.229, 0.224, 0.225)),
    ...
    'disimilar_tasks_mnist': {
        'path': join(_BASE_DATA_PATH, 'mnist'),
        # Use the next 3 lines to use MNIST with a 3x32x32 input
#         'normalize': ((0.1,), (0.2752,)),    # values including padding
        'normalize': ((0.5,), (1.0,)),    # values including padding
        'resize': (32, 32),
        'extend_channel': 3,
        'pad': 4,
        'crop': 32,
    ...
    'disimilar_tasks_fmnist': {
        'path': join(_BASE_DATA_PATH, 'fmnist'),
        # Use the next 3 lines to use MNIST with a 3x32x32 input
#         'normalize': ((0.1,), (0.2752,)),    # values including padding
        'normalize': ((0.5,), (1.0,)),    # values including padding
        'resize': (32, 32),
